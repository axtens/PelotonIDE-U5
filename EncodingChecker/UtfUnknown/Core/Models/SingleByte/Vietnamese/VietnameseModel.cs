...
// Type: UtfUnknown.Core.Models.SingleByte.Vietnamese.VietnameseModel
...
namespace UtfUnknown.Core.Models.SingleByte.Vietnamese
{
  ...
  {
    private static byte[] LANG_MODEL = new byte[3025]
    {
      (byte) 3,
      (byte) 3,
      (byte) 3,
    ...
    public VietnameseModel(byte[] charToOrderMap, string name)
      : base(charToOrderMap, VietnameseModel.LANG_MODEL, 55, 0.9321889f, false, name)
    {
    }
  }
}
