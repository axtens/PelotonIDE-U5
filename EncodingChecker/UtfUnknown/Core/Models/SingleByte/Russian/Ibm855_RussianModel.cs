...
// Type: UtfUnknown.Core.Models.SingleByte.Russian.Ibm855_RussianModel
...
namespace UtfUnknown.Core.Models.SingleByte.Russian
{
  ...
  {
    private static readonly byte[] BYTE_TO_ORDER_MAP = new byte[256]
    {
      (byte) 254,
      (byte) 254,
      (byte) 254,
    ...
    public Ibm855_RussianModel()
      : base(Ibm855_RussianModel.BYTE_TO_ORDER_MAP, "ibm855")
    {
    }
  }
}
