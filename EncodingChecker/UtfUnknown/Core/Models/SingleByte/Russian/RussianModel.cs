...
// Type: UtfUnknown.Core.Models.SingleByte.Russian.RussianModel
...
namespace UtfUnknown.Core.Models.SingleByte.Russian
{
  ...
  {
    protected static readonly byte[] LANG_MODEL = new byte[4096]
    {
      (byte) 0,
      (byte) 3,
      (byte) 3,
    ...
    public RussianModel(byte[] charToOrderMap, string name)
      : base(charToOrderMap, RussianModel.LANG_MODEL, 64, 0.976601f, false, name)
    {
    }
  }
}
