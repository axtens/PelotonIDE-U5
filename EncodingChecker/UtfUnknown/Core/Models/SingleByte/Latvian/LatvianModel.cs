...
// Type: UtfUnknown.Core.Models.SingleByte.Latvian.LatvianModel
...
namespace UtfUnknown.Core.Models.SingleByte.Latvian
{
  ...
  {
    private static byte[] LANG_MODEL = new byte[1521]
    {
      (byte) 2,
      (byte) 3,
      (byte) 3,
    ...
    public LatvianModel(byte[] charToOrderMap, string name)
      : base(charToOrderMap, LatvianModel.LANG_MODEL, 39, 0.9904102f, true, name)
    {
    }
  }
}
