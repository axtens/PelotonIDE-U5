...
// Type: UtfUnknown.Core.Models.MultiByte.Japanese.Iso_2022_JP_SMModel
...
namespace UtfUnknown.Core.Models.MultiByte.Japanese
{
  public class Iso_2022_JP_SMModel : StateMachineModel
  {
    ...
    public Iso_2022_JP_SMModel()
      : base(new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, Iso_2022_JP_SMModel.ISO2022JP_cls), 10, new BitPackage(BitPackage.INDEX_SHIFT_4BITS, BitPackage.SHIFT_MASK_4BITS, BitPackage.BIT_SHIFT_4BITS, BitPackage.UNIT_MASK_4BITS, Iso_2022_JP_SMModel.ISO2022JP_st), Iso_2022_JP_SMModel.ISO2022JPCharLenTable, "iso-2022-jp")
    {
    }
  }
}
