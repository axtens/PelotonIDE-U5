...
// Type: UtfUnknown.Core.Probers.MultiByte.Chinese.EUCTWProber
...
namespace UtfUnknown.Core.Probers.MultiByte.Chinese
{
  public class EUCTWProber : CharsetProber
  {
    ...
    public EUCTWProber()
    {
      this.codingSM = new CodingStateMachine((StateMachineModel) new EUCTWSMModel());
...
label_10:
    ...
    public override string GetCharsetName() => "euc-tw";
