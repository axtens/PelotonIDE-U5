...
// Type: UtfUnknown.Core.Probers.MultiByte.Korean.CP949Prober
...
namespace UtfUnknown.Core.Probers.MultiByte.Korean
{
  public class CP949Prober : CharsetProber
  {
    ...
    public CP949Prober()
    {
      this.codingSM = new CodingStateMachine((StateMachineModel) new CP949SMModel());
      this.distributionAnalyser = new EUCKRDistributionAnalyser();
      this.Reset();
    }

    public override string GetCharsetName() => "cp949";
