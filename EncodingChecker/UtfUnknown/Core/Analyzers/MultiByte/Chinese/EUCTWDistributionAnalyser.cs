...
// Type: UtfUnknown.Core.Analyzers.Chinese.EUCTWDistributionAnalyser
...
namespace UtfUnknown.Core.Analyzers.Chinese
{
  public class EUCTWDistributionAnalyser : CharDistributionAnalyser
  {
    ...
    private static int[] EUCTW_CHAR2FREQ_ORDER = new int[5376]
    {
      1,
      1800,
      1506,
    ...
    public override int GetOrder(byte[] buf, int offset) => buf[offset] >= (byte) 196 ? 94 * ((int) buf[offset] - 196) + (int) buf[offset + 1] - 161 : -1;
  }
}
