...
// Type: UtfUnknown.Core.Analyzers.Chinese.BIG5DistributionAnalyser
...
namespace UtfUnknown.Core.Analyzers.Chinese
{
  public class BIG5DistributionAnalyser : CharDistributionAnalyser
  {
    ...
    private static int[] BIG5_CHAR2FREQ_ORDER = new int[5376]
    {
      1,
      1801,
      1506,
    ...
    public override int GetOrder(byte[] buf, int offset)
    {
      if (buf[offset] < (byte) 164)
        return -1;
      return buf[offset + 1] >= (byte) 161 ? 157 * ((int) buf[offset] - 164) + (int) buf[offset + 1] - 161 + 63 : 157 * ((int) buf[offset] - 164) + (int) buf[offset + 1] - 64;
    }
  }
}
