...
public sealed partial class MainPage : Page
{
    ...
    {
        StorageFile languageConfig = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Presentation\\LanguageConfiguration.json"));
    ...
    {
        StorageFile renderingConfig = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Presentation\\RenderingConstants.json"));
    ...
    {
        StorageFile globalSettings = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Presentation\\FactorySettings.json"));
    ...
    {
        StorageFile tabSettingStorage = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///Presentation\\PerTabInterpreterParameters.json"));
